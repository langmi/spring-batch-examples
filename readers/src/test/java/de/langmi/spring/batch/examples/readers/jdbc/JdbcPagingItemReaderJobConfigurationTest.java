...
@ContextConfiguration({
    "classpath*:spring/batch/job/jdbc-paging-item-reader-job.xml",
...
public class JdbcPagingItemReaderJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file", new JobParameter("file:target/test-outputs/jdbc-paging-item-reader/output.txt"));
