...
public class SplitFileSimpleJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file.first", new JobParameter("file:target/test-outputs/split-file-simple/output-first.txt"));
        jobParametersMap.put("output.file.second", new JobParameter("file:target/test-outputs/split-file-simple/output-second.txt"));
